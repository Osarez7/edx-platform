...
from xblock.fields import Scope, String, Integer, Float, List, Field
...
class XModuleDescriptor(XModuleFields, HTMLSnippet, ResourceTemplates, XBlock):
    ...
    def xmodule(self, system):
        ...
        module = system.construct_block_from_class(
            self.module_class,
            descriptor=self,
    ...
    def editable_metadata_fields(self):
        ...
        if getattr(self, 'mixin_class', False):
            fields = self.__class__.__bases__[0].fields
        else:
            fields = self.fields
